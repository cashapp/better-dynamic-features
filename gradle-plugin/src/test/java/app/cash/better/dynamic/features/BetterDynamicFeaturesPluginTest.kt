...
class BetterDynamicFeaturesPluginTest {
  ...
  @Test fun `new transitive dependency is recorded in lockfile`() {
    ...
    assertThat(baseProject.lockfile().readText()).isEqualTo(
      ...
      |androidx.lifecycle:lifecycle-viewmodel-savedstate:2.5.0=debugRuntimeClasspath,releaseRuntimeClasspath
      ...
      |org.jetbrains.kotlin:kotlin-stdlib-jdk7:1.6.0=debugRuntimeClasspath,releaseRuntimeClasspath
      |org.jetbrains.kotlin:kotlin-stdlib-jdk8:1.6.0=debugRuntimeClasspath,releaseRuntimeClasspath
      |org.jetbrains.kotlin:kotlin-stdlib:1.7.10=debugRuntimeClasspath,releaseRuntimeClasspath
      |org.jetbrains.kotlinx:kotlinx-coroutines-android:1.6.1=debugRuntimeClasspath,releaseRuntimeClasspath
      |org.jetbrains.kotlinx:kotlinx-coroutines-bom:1.6.1=debugRuntimeClasspath,releaseRuntimeClasspath
      |org.jetbrains.kotlinx:kotlinx-coroutines-core-jvm:1.6.1=debugRuntimeClasspath,releaseRuntimeClasspath
      |org.jetbrains.kotlinx:kotlinx-coroutines-core:1.6.1=debugRuntimeClasspath,releaseRuntimeClasspath
      |org.jetbrains:annotations:13.0=debugRuntimeClasspath,releaseRuntimeClasspath
      |empty=
      """.trimMargin(),
    )
